...
-- AddForeignKey
ALTER TABLE "tests" ADD CONSTRAINT "tests_teacherDiciplineId_fkey" FOREIGN KEY ("teacherDiciplineId") REFERENCES "teachersDisciplines"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
